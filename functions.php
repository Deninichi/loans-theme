...
function loans_enqueue_scripts() {
	...
	wp_enqueue_style('loans-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), '4.1.3' );
   	wp_enqueue_style('loans-style', get_stylesheet_uri(), array(), '_bld_1539290207011' );
   	wp_enqueue_style('loans-style-build', get_template_directory_uri() . '/assets/dist/css/style.css', array(), '_bld_1539290207011' );

    wp_enqueue_script('loans-script-build', get_template_directory_uri() . '/assets/dist/js/build.js', array('jquery'), '_bld_1539290207011', true );
    wp_enqueue_script('bootstrap-script', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '_bld_1539290207011', true );
    wp_enqueue_script('loans-script', get_template_directory_uri() . '/assets/js/custom-scripts.js', array('jquery'), '_bld_1539290207011', true );
